...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      backend_js: {
        files: {
          '<%= dirs.js %>/wp-demo-plugin-admin.js': [
    ...
    makepot: {
      target: {
        options: {
          ...
          mainFile: 'wp-demo-plugin.php',
          domainPath: '/languages/',
          potFilename: 'wp-demo-plugin.pot',
          type: 'wp-plugin',
    ...
    sftp: {
      upload: {
        files: {
          './': 'build/wp-demo-plugin-v' + pkg.version + '.zip'
        },
        options: {
          path: '<%= secret.path %>',
          config: 'myhost',
